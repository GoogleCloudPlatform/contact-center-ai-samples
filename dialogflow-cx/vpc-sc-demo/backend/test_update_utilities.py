...
@pytest.mark.parametrize('restrict_access,status,expected',[
...
@pytest.mark.parametrize('restrict_access,status',[
...
@patch.object(su, 'get_service_perimeter_data_uri', return_value={'response': 'MOCK_RESPONSE'})
